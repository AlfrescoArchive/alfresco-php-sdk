 ...
 */
	 ...
	 * content node.
	 *
	 * A discussion of this tutorial can be found at http://wiki.alfresco.com/wiki/PHP_Tutorial_Four
	 *
	 * Note: any changes to this file should be uploaded to the wiki
	 */

	// Include the required Alfresco PHP API objects
	if (!isset($_SERVER["ALF_AVAILABLE"])) {
	...
	// Use a search to get the content node we are updating
	...
	{
		// Set the updated title and description values
		$contentNode->cm_title = $_REQUEST["title"];
		$contentNode->cm_description = $_REQUEST["description"];

		// Save the session.  This ensures that the updates are persisted back to the repository.
