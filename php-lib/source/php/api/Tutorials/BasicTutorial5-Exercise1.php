 ...
 */
	...
	/**
	 * Basic Tutorial Five - Exercise 1 (Solution)
	 *
	...
	// Use a search to get the guest home space we will use to place the new content in
	...
	if (isset($_REQUEST["create"]) == true)
	{
		...
		// We are going to assume the mime-type and encoding for ease
...
<body>
    ...
    <form action="BasicTutorial5-Exercise1.php" method="post" enctype="multipart/form-data">
